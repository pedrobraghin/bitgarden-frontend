...
export function EditMode({ onSave, onCancel }: Readonly<EditModeProps>) {
  ...
  const { hasUnsavedChanges, resetUnsavedChanges, error, setError } =
    useEditUserStore();
  ...
  const handleFinalize = useCallback(async () => {
    ...
    onSave();
  }, [onSave, hasUnsavedChanges, updateUser, error]);
  ...
  const handleCancel = useCallback(() => {
    ...
    onCancel();
  }, [onCancel, hasUnsavedChanges, resetUnsavedChanges]);
